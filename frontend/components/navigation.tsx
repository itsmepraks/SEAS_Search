...
import { MessageSquare, Database, FileText, BarChart3, GraduationCap } from "lucide-react"
...
const navItems = [
  ...
  { href: "/visualizations", label: "Charts", icon: BarChart3 },
]
      ...
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4">
        <Link href="/" className="group flex items-center gap-2.5 transition-all duration-200">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-semibold tracking-tight leading-none">GWU Course LLM</span>
            <span className="text-[10px] text-muted-foreground/60 leading-none mt-0.5">Research Interface</span>
          </div>
        </Link>
